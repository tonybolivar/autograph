var AG_LABEL_ALIASES = [
  ...
  [["desired_salary", "desired salary", "desired pay", "desiredpay", "pay expectations", "salary expectation", "expected salary", "salary expectations", "compensation expectation", "expected compensation", "annual salary"], "desired_salary"],
  ...
  [["earliest_start_date", "earliest start date", "start date", "available start", "when can you start", "earliest start", "date available", "available date", "date of availability"], "earliest_start_date"],
  ...
  [["previously_employed_here", "previously employed", "worked here before", "former employee", "have you ever worked", "ever worked", "been employed by", "have you been employed", "candidateispreviousworker", "previous worker", "previous employee"], "previously_employed_here"],
  [["age_over_18", "18 or older", "over 18", "at least 18", "are you 18", "minimum age", "age requirement"], "age_over_18"],
  ...
  [["military_service_branch", "military branch", "service branch", "branch of service", "branch of the military"], "military_service_branch"],
  [["military_discharge_type", "discharge type", "type of discharge", "discharge status"], "military_discharge_type"],
  [["highest_education_level", "highest level of education", "highest education", "highest degree obtained", "education_level"], "highest_education_level"],
  [["secondary_email", "alternate email", "second email", "secondary_email_address", "alt email", "other email"], "secondary_email"],
  [["secondary_phone", "alternate phone", "second phone", "alt phone", "other phone", "home phone"], "secondary_phone"],
  [["coding_assessment_url", "coding sample", "live coding", "coding test url", "assessment url", "code sample url"], "coding_assessment_url"],
  [["portfolio_password", "portfolio_password", "portfolio access code", "portfolio passcode"], "portfolio_password"],
  [["preferred_interview_time", "interview availability", "best time for interview", "interview time", "interview slot"], "preferred_interview_time"],
  [["internship_or_fulltime", "internship or full time", "full time or internship", "intern or full time"], "internship_or_fulltime"],
